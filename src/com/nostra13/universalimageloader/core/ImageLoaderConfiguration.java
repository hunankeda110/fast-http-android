...
public final class ImageLoaderConfiguration {
    ...
    public static class Builder {
         ...
         *            null-ok; {@linkplain BitmapProcessor Bitmap processor} which process images before
         *            saving them in disc cache
         */
         ...
         * <br />
         * <b>NOTE:</b> If you set custom executor then following configuration options will not be considered
         * for this executor:
         * <ul>
        ...
        /**
         * Sets custom {@linkplain Executor executor} for tasks of displaying <b>cached on disk</b> images
         * (these tasks are executed quickly so UIL prefer to use separate executor for them).<br />
         * <br />
         * If you set the same executor for {@linkplain #taskExecutor(Executor) general tasks} and tasks about
         * cached images (this method) then these tasks will be in the same thread pool. So short-lived tasks
         * can wait a long time for their turn.<br />
         * <br />
         * <b>NOTE:</b> If you set custom executor then following configuration options will not be considered
         * for this executor:
         * <ul>
        ...
        /**
         * When you display an image in a small {@link android.widget.ImageView ImageView} and later you try
         * to display this image (from identical URI) in a larger {@link android.widget.ImageView ImageView}
         * so decoded image of bigger size will be cached in memory as a previous decoded image of smaller
         * size.<br />
         * So <b>the default behavior is to allow to cache multiple sizes of one image in memory</b>. You can
         * <b>deny</b> it by calling <b>this</b> method: so when some image will be cached in memory then
         * previous cached size of this image (if it exists) will be removed from memory cache before.
         */
         ...
         * {@link com.nostra13.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be
         ...
         * <b>NOTE:</b> If you use this method then
         * {@link com.nostra13.universalimageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache} will be
         * used as disk cache. You can use {@link #diskCache(DiskCache)} method for introduction your own
        ...
        /**
         * Sets default {@linkplain DisplayImageOptions display image options} for image displaying. These
         * options will be used for every
         * {@linkplain ImageLoader#displayImage(String, android.widget.ImageView) image display call} without
         * passing custom {@linkplain DisplayImageOptions options}<br />
         ...
         * Consider {@link com.nostra13.universalimageloader.utils.L#disableLogging()} to disable ImageLoader
         * logging completely (even error logs)
         */
        ...
        private void initEmptyFieldsWithDefaultValues() {
            ...
            if (diskCache == null) {
                ...
                diskCache = DefaultConfigurationFactory.createDiskCache(context, diskCacheFileNameGenerator,
    ...
    /**
     * Decorator. Handles <a href="http://code.google.com/p/android/issues/detail?id=6066">this problem</a> on
     * slow networks using {@link com.nostra13.universalimageloader.core.assist.FlushedInputStream}.
     * 
     * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
     * @since 1.8.1
     */
